package Nicira_controller_4621_x86_64;
...
B<nicira-controller-4621-x86_64.pm> - nicira-controller-4621-x86_64.pm source handler

=head1 SYNOPSIS

source handler for nicira-controller-4621-x86_64
...
sub external_source_handler() {
    ...
    my $basepath = "/var/spool/baracus/builds/nicira-controller/4621/x86_64";
