...
B<Debian-6.0.0-x86_64> - Debian-6.0.0-x86_64 source handler

=head1 SYNOPSIS

source handler for debian-6.0.0-x86_64
...
sub external_source_handler() {
    ...
    my $basepath = "/var/spool/baracus/builds/debian/6.0.0/x86_64";
