...
B<Debian-5.0.7-x86_64> - Debian-5.0.7-x86_64 source handler

=head1 SYNOPSIS

source handler for debian-5.0.7-x86_64
...
sub external_source_handler() {
    ...
    my $basepath = "/var/spool/baracus/builds/debian/5.0.7/x86_64";
