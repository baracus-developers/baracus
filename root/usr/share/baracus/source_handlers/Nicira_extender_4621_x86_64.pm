package Nicira_extender_4621_x86_64;
...
B<nicira-extender-4621-x86_64.pm> - nicira-extender-4621-x86_64.pm source handler

=head1 SYNOPSIS

source handler for nicira-extender-4621-x86_64
...
sub external_source_handler() {
    ...
    my $basepath = "/var/spool/baracus/builds/nicira-extender/4621/x86_64";
