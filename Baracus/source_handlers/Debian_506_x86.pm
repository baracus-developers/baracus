...
B<Debian-5.0.6-x86> - Debian-5.0.6-x86 source handler

=head1 SYNOPSIS

source handler for debian-5.0.6-x86
...
sub external_source_handler() {
    ...
    my $basepath = "/var/spool/baracus/builds/debian/5.0.6/x86";
